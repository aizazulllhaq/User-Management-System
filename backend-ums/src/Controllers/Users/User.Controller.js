...
export const register = wrapAsync(async (req, res, next) => {
  ...
  try {
    ...
    <br>
      ...
      <a href="${FRONTEND_URL}/verify-email/${token}" style="background-color: #4CAF50; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; border-radius: 5px;">Verify Email</a>
